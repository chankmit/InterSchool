    ...
    <body> 
        ...
        <div class="slider-area">
            <div class="preview-2">
                <div id="nivoslider" class="slides">	
                    <img src="{{ asset('img/slider/6.png') }}" alt="" title="#slider-1-caption1"/>
                    <img src="{{ asset('img/slider/1.png') }}" alt="" title="#slider-1-caption2"/>
                </div> 
                            ...
                            <div class="row">
                                <div class="col-md-7 col-sm-7">
                                    <div class="text-content hidden-xs">
                                        ...
                                        <p class="sub-title" style="text-shadow: 1px 1px 1px white;">{{ __('menu.description') }}</p>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4 activity">
                        <div class="single-activity">
                            ...
                            <h4>{{ __('menu.funnygame') }}</h4>
                            <p>{{ __('menu.funnygamedes') }}</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 activity">
                        <div class="single-activity">
                    ...
                    <div class="col-md-3 col-sm-4 activity">
                        <div class="single-activity">
                            ...
                            <h4>{{ __('menu.showact') }}</h4>
                            <p>{{ __('menu.showactdes') }}</p>
                        </div>
                    </div>
        ...
        <div class="advertise-area text-center section-gray">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>{{ __('menu.enroll') }}</h2>
                        <a href="#">{{ __('menu.joinus') }}</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4 hidden-sm hidden-xs">
                        <div class="single-service-item-wrapper">
                            ...
                            <div class="single-service-item">
                                <div class="single-service-text">
                                    <h4>{{ __('menu.language') }}</h4>
                                    <p>{{ __('menu.languagedes') }}</p>
                                </div>
                                <div class="single-service-icon">
                            ...
                            <div class="single-service-item">
                                <div class="single-service-text">
                                    <h4>{{ __('menu.transport') }}</h4>
                                    <p>{{ __('menu.transportdes') }}</p>
                                </div>
                                <div class="single-service-icon">
                                    <i class="fa fa-bus"></i>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="single-service-item-wrapper">
                            <div class="single-service-item">
                                ...
                                <div class="single-service-text">
                                    <h4>{{ __('menu.fullday') }}</h4>
                                    <p>{{ __('menu.fulldaydes') }}</p>
                                </div>
                            </div>
                            <div class="single-service-item">
                                <div class="single-service-icon">
                                ...
                                <div class="single-service-text">
                                    <h4>{{ __('menu.special') }}</h4>
                                    <p>{{ __('menu.specialdes') }}</p>
                                </div>
                            </div>
                            <div class="single-service-item">
                                <div class="single-service-icon">
                                ...
                                <div class="single-service-text">
                                    <h4>{{ __('menu.special2') }}</h4>
                                    <p>{{ __('menu.special2des') }}</p>
                                </div>
                            </div>
                        </div> 
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="view-gallery text-center">
                            <h4>{{ __('menu.viewgallery') }}</h4>
                            <a href="#" class="button-default"> {{ __('menu.viewnow') }} </a>
                        </div>
                    </div>
                </div>
            </div>
